...
export default function CreativeStudio() {
  ...
  return (
    <div ref={containerRef} className="bg-white text-black overflow-hidden">
      ...
      <motion.div 
        style={{ opacity, scale }}
        className="relative w-full h-[70vh] overflow-hidden rounded-2xl mx-auto max-w-6xl mt-10 mb-12 shadow-2xl"
      >
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-6">
              <motion.h2
                ...
                className="text-4xl md:text-6xl font-bold text-black drop-shadow-lg"
              >
              ...
              <motion.p
                ...
                className="mt-4 text-lg md:text-2xl font-light text-gray-700 drop-shadow"
              >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="mt-8 bg-gradient-to-r from-blue-500 to-sky-500 text-white px-8 py-3 rounded-full font-semibold shadow-lg"
              >
                Explore Collection
              </motion.button>
            </div>
        ...
        <AnimatePresence mode="popLayout">
          {filteredServices.map((service) => (
            <motion.div
              ...
              className="bg-black/30 backdrop-blur-md text-white rounded-2xl shadow-xl overflow-hidden relative group border border-gray-700/50"
            >
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-3 left-3 bg-gray-900/50 backdrop-blur-sm px-3 py-1.5 rounded-full flex items-center gap-2">
                  {service.icon}
              ...
              <div className="p-5">
                ...
                <p className="text-gray-900 text-sm mb-2">{service.description}</p>
                <div className="flex justify-between items-center mt-3">
                  <span className="text-black font-bold text-lg">{service.price}</span>
                  <motion.button
                    id={`add-to-cart-${service.id}`}
                    whileTap={{ scale: 0.9 }}
                    onClick={() => addToCart(service)}
                    className="bg-gradient-to-r from-blue-500 to-sky-500 text-white px-4 py-2 rounded-lg shadow-md hover:shadow-lg transition-shadow"
                  >
                    Add to Cart
                  </motion.button>
                </div>
      ...
      >
        <div className="text-center mb-12">
          <motion.h2 
            className="text-3xl md:text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-black to-gray-400"
